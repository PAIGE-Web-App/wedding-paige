...
import { WizardStep, WizardGroup, StepStatus } from "@/types/wizard";
...
export function WizardNavigation({
  ...
  const hasActiveStepInGroup = useMemo(() => {
    ...
    return active;
  }, [groups, stepIdToIndex, currentStepIndex]);
  ...
  }, [groups, isGroupCompleted, hasActiveStepInGroup]);
  ...
  const renderGroup = (group: WizardGroup, groupIndex: number) => {
  ...
  return (
    <div className="flex w-full flex-col bg-muted/30 lg:w-[280px] lg:min-w-[280px]">
      <div className="p-6">
        <Image
          src="/images/logo.png"
          alt="Paige+"
